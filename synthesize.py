...
import catala_transcriber as trns
import pickle
...
def synthesize(text):
   ...
   for word in text.split(' '):
      transcription += trns.transcribe(word)
   ...
   print('Diphone _'.join(target.getDiphone())+f' retrieved from file {filename} at times '+str(t1)+' and '+str(t2))
